...
?>
<form id="register" name="register" action="?p=register" method="POST">
<table>
	<tr><th colspan="2">Please enter the following information to reguster for your Swap account</th></tr>
