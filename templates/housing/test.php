...
<table>
	<tr><th>Item Name</th><td><input type="text" name="name" /> (50 Character Limit)</td></tr>
	<tr><th>Main Category</th><td>
    <span spry:region="dsParents" id="parentSelector">
		<select spry:repeatchildren="dsParents" name="parentSelect" onchange="document.forms[0].subSelect.disabled = true; dsParents.setCurrentRowNumber(this.selectedIndex);">
...
<h3>Try to make your photo clearly show the item you wish to trade</h3>
<table>
