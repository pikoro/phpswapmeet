    ...
    <form id="add_item" name="add_item" enctype="multipart/form-data" method="POST" action="?p=add_item">
        ...
        <table>
            ...
            <tr><th>Main Category</th><td>
                    <span spry:region="dsParents" id="parentSelector">
                        <select spry:repeatchildren="dsParents" name="parentSelect" onchange="document.forms[1].subSelect.disabled = true;
                                dsParents.setCurrentRowNumber(this.selectedIndex);">
        ...
        <table>
            <tr><th>Additional Notes</th><td width="600px">
                    ...
                    $oFCKeditor->Value = filter_input(INPUT_POST, 'description');
