...
//print_r($wanted);
    ...
    ?></div>
<h2>Things I Have</h2><div style="text-align:right;font-size:small; float:right; margin-right:10px;"><?
    if ($_SESSION[active] == 1) {
        echo '<a href="?p=add_item"><img src="templates/' . $config[site][template] . '/images/add-item.png" width="100"/></a>';
    }
    ?></div>
<div class="sidebarlt">
